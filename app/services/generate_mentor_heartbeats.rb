  ...
  def call
    active_mentors.find_each do |mentor|
      ...
      if email_log.mentor_heartbeat_sent_at.nil?
        ...
        introduction = %Q{One of the best things about Exercism is the opportunity to explore ideas with others. Our Slack room is great for that but it only engages a tiny percentage of people, so we're exploring ways we could be directly embedding conversations and discussions into Exercism itself. If you mentor but don't use Slack, we'd love to hear from you, and understand your reasons for not using it, and what we could do better moving forward. We talk a little more aobut this in Tactic 5 of our strategy document: https://exercism.io/strategy}
      end
